...
class SvgSalonParser {
  ...
  static MapNode? _findNearestNode(Offset point, List<MapNode> nodes) {
  ...
  /// Por ahora, asumimos que room01, room02, etc. se mapean a salones
  /// Esto es una aproximación - idealmente deberías tener un mapeo real
  static String _formatSalonId(String roomId, int piso) {
    ...
    // Esto es temporal - deberías tener un mapeo real
    // Asumir Torre A por defecto (puedes mejorar esto)
