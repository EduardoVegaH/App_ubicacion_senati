...
class GraphEdgesConfig {
  ...
  static Future<List<EdgeModel>> getPiso2EdgesManual(
    List<MapNodeModel> nodes, {
    String? svgPath,
  }) async {
    ...
    for (final (fromId, toId) in connections) {
      ...
      final weight = math.sqrt(dx * dx + dy * dy);
  ...
  static Future<List<EdgeModel>> getManualEdgesForFloor(
    int piso,
    List<MapNodeModel> nodes, {
    String? svgPath,
  }) async {
