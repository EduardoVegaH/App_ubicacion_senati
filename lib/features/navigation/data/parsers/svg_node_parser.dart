...
class SvgNodeParser {
  ...
  /// 
  /// Retorna una lista de MapNodeModel con todos los nodos encontrados
  static Future<List<MapNodeModel>> parseNodesFromSvg({
  ...
  static Future<Map<int, List<MapNodeModel>>> parseAllSvgs({
    required Map<int, String> svgPaths,
  }) async {
    final Map<int, List<MapNodeModel>> nodesByFloor = {};
